...
Keep ELIS a faithful, testable native Lupi simulator while making Workshop a reliable authoring path for layered maps, palettes, and exported `ui.map` data.
...
- Revisit broader authoring or runtime capabilities only with a bounded use case and a matching automated proof path.
