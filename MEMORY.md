...
- Treat downloaded demos and local Lua games as untrusted input when changing archive, filesystem, or network handling. Automatic conversion pins lupi-codec revision `3e8c66299a4606b36b9f490212acc44e084a6aa2`; downloads allow HTTPS redirects only, stop at 64 MiB before conversion, and release per-demo extraction roots before processing the next catalog entry.
